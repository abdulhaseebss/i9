  ...
  return (
    <>
      <div className="flex justify-center">
        <p className="text-center font-bold text-[46px] max-[850px]:text-4xl max-[700px]:text-3xl">The Importance of <span className="text-[#8ABC3E]">Customized Clinic</span>  & <br /> <span className="text-[#8ABC3E]">Pharmacy App Development</span> </p>
      </div>
