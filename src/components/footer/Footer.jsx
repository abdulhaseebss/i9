...
const Footer = () => {
  return (
    <>
        <div className='flex justify-center outfit mt-20 mb-[-8vh] z-50 relative max-[1340px]:mb-[-8vh] max-[1200px]:mb-[20vh]'>
        ...
        <div className='outfit max-[1200px]:mt-[15vh] max-[1200px]:mb-[8vh] max-[1450px]:h-[200px]'>
            <img className='absolute  transition-all h-[70vh]' src={rectangle} alt="rectangle" />
            ...
            <div className=' flex justify-between max-[600px]:justify-center max-[800px]:justify-center text-white relative items-start h-full z-50 px-28 gap-12'>
                ...
                <div className='mt-[12vh] max-[1340px]:mt-[18vh] max-[600px]:w-full'>
                    ...
                    <div className='flex flex-wrap gap-3 mt-3 justify-between max-[800px]:justify-center'>
        ...
        <div className='relative z-50 bottom-0 mt-64 max-[1400px]:mt-52 outfit bg-[#006FAF] text-center text-white p-8'>
